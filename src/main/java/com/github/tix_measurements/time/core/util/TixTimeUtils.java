...
public class TixTimeUtils {
	 ...
	 */
	public static final int KEY_PAIR_BITS_LENGTH = 512;
	 ...
	 */
	public static byte[] sign (String message, KeyPair keyPair) {
		try {
	 ...
	 * @param message {@link} String representing the message to verify
	 ...
	 */
	public static boolean verify(String message, byte[] encodedPublicKey, byte[] signature) {
		try {
